...
def take_bet(chips):
    ...
    while True:
        try:
            chips_bet = int(input('How much would you like to bet? '))
        except:
            print('Sorry, your bet must be an integer!')
        else:
            if chips.total < chips_bet:
                print(f'Sorry, your bet must be less than {chips.total}')
            else:
                break
    return chips_bet
...
def hit_or_stand(deck,hand):
    ...
    if player_choice.lower() == 's':
        ...
        print('Please only provide "Hit" or "Stand"!')
